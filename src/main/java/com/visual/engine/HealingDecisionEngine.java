...
final class HealingDecisionEngine {
    ...
    HealingDecision decide(String key, BufferedImage pageImg, List<HeatmapRenderer.Candidate> heatCandidates,
        ...
        return promptUserLoop(key, pageImg, heatCandidates, rankedCandidates);
    }

    private HealingDecision promptUserLoop(String key, BufferedImage pageImg,
                                           List<HeatmapRenderer.Candidate> heatCandidates, List<CandidateScore> rankedCandidates) {
