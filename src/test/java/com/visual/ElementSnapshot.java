...
public class ElementSnapshot {
    public String locator, screenshotBase64, text, pageUrl, kind, tagName;
    public int x, y, w, h;
    public ElementSnapshot() {}
    public ElementSnapshot(String loc, String b64, int x, int y, int w, int h, String txt, String url, String kind, String tagName) {
